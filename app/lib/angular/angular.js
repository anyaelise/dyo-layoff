 ...
 * dyoLayoff.run(function($templateCache) {
 ...
 *    angular.module('dyoLayoff', []).config(function($sceDelegateProvider) {
...
<file name="index.html">
  <div ng-controller="dyoLayoffController as myCtrl">
...
<file name="script.js">
  ...
  mySceApp.controller("dyoLayoffController", function dyoLayoffController($http, $templateCache, $sce) {
    var self = this;
 ...
 *
 * <pre class="prettyprint">
 *   angular.module('dyoLayoffWithSceDisableddyoLayoff', []).config(function($sceProvider) {
