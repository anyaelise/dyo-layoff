 ...
 *
 * <pre>
 *   dyoLayoffDev = angular.module('dyoLayoffDev', ['dyoLayoff', 'ngMockE2E']);
 *   dyoLayoffDev.run(function($httpBackend) {
...
(window.jasmine || window.mocha) && (function(window) {
   ...
   * <pre>
   *
   *   angular.module('dyoLayofflicationModule', [])
   *       .value('mode', 'app')
   ...
   *     beforeEach(module('dyoLayofflicationModule'));
   *
   *
